...
void default_minions(int &gottendrop, int &newhp, int &newattack, int &newcoins, string &newname)
{
    if (gottendrop <= 25)
    {
        goblin.name = "Goblin";
...
void bossfight(int &gottendrop, string &message, int &valkyriesword, int &rock, int &flesh, int &metal, int &aotfk)
{
    int newhp, newattack, newcoins;
    string newname;
    gottendrop = 101;
    default_minions(gottendrop, newhp, newattack, newcoins, newname);
    while (newhp > 0)
    {
...
void myhero(string &message, int &choice, int &gottendrop, int &valkyriesword, int &rock, int &flesh, int &metal, int &aotfk, string &dropname, int &price, int &value, int &valkyrieswordequipped, int &rockequipped, int &fleshequipped, int &metalequipped, int &aotfkequipped)
{
    cout << endl;
    cout << endl;
    cout << endl;
...
void fight(int &gottendrop, string &message, int &valkyriesword, int &rock, int &flesh, int &metal, int &aotfk, int &price, int &value, string &dropname)
{
    int newhp, newattack, newcoins;
    string newname;
        ...
        while (okk != 1)
        {
            ...
            while (okkk!=1)
            {
                if (me.hp > 0)
                {
                    ...
                    if (choice == 1)
                    {
                        fight(gottendrop, message, valkyriesword, rock, flesh, metal, aotfk, price, value, dropname);
                    }
                    else if (choice == 2)
                    {
                        bossfight(gottendrop, message, valkyriesword, rock, flesh, metal, aotfk);
                    }
                    else if (choice == 3)
                    {
                    ...
                    {
                        myhero(message, choice, gottendrop, valkyriesword, rock, flesh, metal, aotfk, dropname, price, value, valkyrieswordequipped, rockequipped, fleshequipped, metalequipped, aotfkequipped);
                    }
                    else if (choice == 5)
                    {
